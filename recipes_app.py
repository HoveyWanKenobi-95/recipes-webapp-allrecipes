...
prep_time_cutoff = st.slider('Maximum Prep Time', min_value = data.prep_time.min(), max_value =  data.prep_time.max(), value = 30, step=1)
total_time_cutoff = st.slider('Maximum Total Time', min_value = data.total_time.min(), max_value =  data.total_time.max(), value = 30, step=1)
